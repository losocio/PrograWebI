...
function mueveRana(el)
{
	...
	if (document.getElementById(el.id).src.includes("L.png")) //Get image L.png, B.png or R.png
	{
//		It is a Left Frog
...
//			alert("Moving the frog forward!")
			...
			if(document.getElementById(id_el+1).src.includes("R.png")) 
			{
//				alert("Moving the frog forward on a frog!")
		...
		if (document.getElementById(el.id).src.includes("R.png")) //Get image L.png, B.png or R.png
		{	
		// It's a Rigth Frog
			if(document.getElementById(id_el-1).src.includes("B.png")) 
			{
//				alert("Moving the frog forward!")
				...
				if(document.getElementById(id_el-2).src.includes("L.png")) 
			{
//				alert("Moving the frog forward!")
                frog_swap(id_el,id_el-2)
			}		
